...
from app.data_processors import DWDSDataProcessor
...
def test_get_data_from_dwds(word: str, initial_note: CustomNote, snapshot: Any) -> None:
    result: CustomNote | None = DWDSDataProcessor().get_note_data(
